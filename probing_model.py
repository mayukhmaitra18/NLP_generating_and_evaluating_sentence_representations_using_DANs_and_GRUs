...
class ProbingClassifier(models.Model):
    def __init__(self,
        ...
        self.classification = tf.keras.layers.Dense(self.class_num, activation='softmax', use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros')
    ...
    def call(self, inputs: tf.Tensor, training: bool =False) -> tf.Tensor:
        ...
        # TODO(students): start
        # ...
        inp = self._pretrained_model(inputs)['layer_representations'][self._layer_num]
        logits = self.classification(inp)
